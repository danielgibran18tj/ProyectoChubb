...
CREATE DATABASE [ChubbSeguroDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ChubbSeguroDB', FILENAME = N'/var/opt/mssql/data/ChubbSeguroDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ChubbSeguroDB_log', FILENAME = N'/var/opt/mssql/data/ChubbSeguroDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO
ALTER DATABASE [ChubbSeguroDB] SET COMPATIBILITY_LEVEL = 160
GO
...
GO
ALTER DATABASE [ChubbSeguroDB] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
EXEC sys.sp_db_vardecimal_storage_format N'ChubbSeguroDB', N'ON'
GO
ALTER DATABASE [ChubbSeguroDB] SET QUERY_STORE = ON
GO
ALTER DATABASE [ChubbSeguroDB] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
USE [ChubbSeguroDB]
GO
